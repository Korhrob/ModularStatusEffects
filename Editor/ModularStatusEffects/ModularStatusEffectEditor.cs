...
public class ModularStatusEffectEditor : Editor {
    ...
    SerializedProperty customVisualTypeProp;
    ...
    void OnEnable() {
        ...
        customVisualTypeProp = serializedObject.FindProperty("customVisualType");
    ...
    public override void OnInspectorGUI() {
        ...
        if (visualEffectTypeProp.intValue != 0) {
            ...
            EditorGUILayout.PropertyField(customVisualTypeProp);
        }
        ...
        for (int i = 0; i < modulesProp.arraySize; i++) {
            ...
            StatusEffectComponent component = componentProp.objectReferenceValue as StatusEffectComponent;

            if (component != null && component.GetType() == typeof(ComponentCopyTargetPosition)) {
                EditorGUILayout.Space();
                continue;
            }
