...
namespace ModularStatusEffects {
    ...
    public abstract class StatusEffectComponent : ScriptableObject
    {
        ...
        public abstract void OnExpire(Character c, StatusEffectInstance instance, StatusEffectModule module);
        public abstract void OnRemove(Character c, StatusEffectInstance instance, StatusEffectModule module);
